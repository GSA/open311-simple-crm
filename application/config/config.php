...
|
*/
$config['encryption_key'] = Environment::get('CRM_ENCRYPTION_KEY');
...
$config['cookie_secure']	    = Environment::get('CRM_COOKIE_SECURE', FALSE);
$config['cookie_httponly']	    = TRUE;
$config['sess_expiration']		= 900;
$config['sess_encrypt_cookie']	= FALSE;
$config['sess_use_database']	= Environment::get('SESS_USE_DATABASE', TRUE);

...
$saml2_debug = Environment::get('SAML2_DEBUG', FALSE);
$saml2_admin_password = Environment::get('SAML2_ADMIN_PASSWORD');
$saml2_trusted_domains = Environment::get('SAML2_TRUSTED_DOMAINS', []);
$saml2_cookie_secure = Environment::get('SAML2_COOKIE_SECURE', TRUE);

// Convert comma-separated string to array
if ($saml2_trusted_domains && is_string($saml2_trusted_domains)) {
    $saml2_trusted_domains = explode(',', $saml2_trusted_domains);
}
...
$config = array(
     ...
     */
    'auth.adminpassword' => $saml2_admin_password,
     ...
     */
    'session.cookie.secure' => $saml2_cookie_secure,
     ...
     */
    'trusted.url.domains' => $saml2_trusted_domains,

...
$db['default']['hostname'] = Environment::get('DB_HOST');
$db['default']['username'] = Environment::get('DB_USER');
$db['default']['password'] = Environment::get('DB_PASSWORD');
$db['default']['database'] = Environment::get('DB_NAME');

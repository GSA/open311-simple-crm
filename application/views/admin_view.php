...
if("<?php echo $currmethod; ?>"=="index"){
    ...
    $("#categorylist").html('<select id="categorylistselect" class="form-control"><?php foreach($categorieslist->result() as $cl){?><option value="<?php echo $cl->category_id; ?>"><?php echo $cl->category_name; ?></option><?php }?></select>');

...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
      ...
      <link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/fms-endpoint/css/print.css')?>" media="print" />

      <?php if (config_item('cobrand_name')) { ?>
        <link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/cobrands/')?><?php echo config_item('cobrand_name'); ?>/style.css" />
      <?php } ?>
